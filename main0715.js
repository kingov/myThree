...
var threeBase = function () {
    function threeBase() {
        (0, _classCallCheck3.default)(this, threeBase);
    ...
    (0, _createClass3.default)(threeBase, [{
        key: 'initRenderer',
        value: function initRenderer() {
            this.renderer = new THREE.WebGLRenderer({ antialias: true });
            this.renderer.setSize(window.innerWidth - 250, window.innerHeight);
            this.renderer.setClearColor(0xffffff);
            document.getElementById('webglBox').appendChild(this.renderer.domElement);
        }
    }, {
        key: 'initScene',
        ...
        value: function initCamera() {
            this.camera = new THREE.PerspectiveCamera(45, (window.innerWidth - 250) / window.innerHeight, 1.0, 100000000);
            this.camera.position.set(120000, 120000, 120000);
...
var myPro = function (_threeBase) {
    (0, _inherits3.default)(myPro, _threeBase);

    function myPro() {
        (0, _classCallCheck3.default)(this, myPro);

        // this.initBox();
        var _this = (0, _possibleConstructorReturn3.default)(this, (myPro.__proto__ || (0, _getPrototypeOf2.default)(myPro)).call(this));

        _this.elements = [];
        _this.webglBox = document.getElementById('webglBox');
        _this.loadModel2();
        _this.selectItem();
        return _this;
    }

    (0, _createClass3.default)(myPro, [{
        key: 'initBox',
        value: function initBox() {
            var cubeGeometry = new THREE.CubeGeometry(1000, 1000, 1000);
            var cubeMaterial = new THREE.MeshLambertMaterial({ color: 0x333666 });
            var cube = new THREE.Mesh(cubeGeometry, cubeMaterial);
            this.scene.add(cube);
        }
    }, {
        key: 'loadModel2',
        value: function loadModel2() {
            var loader = new THREE.ObjectLoader();
            var that = this;
            for (var i = 1; i < 22; i++) {
                loader.load('./libs/models/' + i + '.json', function (obj) {
                    obj.children.forEach(function (item) {
                        ...
                        if (item.children.length > 0) {
                            ...
                            try {
                                ...
                                for (var _iterator = (0, _getIterator3.default)(item.children), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                                    var _i = _step.value;

                                    _i.material.transparent = true;
                                    _i.material.opacity = 0.4;
                                    that.elements.push(_i);
                                }
                            } catch (err) {
        ...
        value: function selectItem() {
            ...
            this.webglBox.onmousedown = function (e) {
                e.preventDefault();
                x1Position = e.clientX - 250;
            };
            this.webglBox.onmousemove = function (e) {
                x2Position = e.clientX - 250;
            };
            this.webglBox.onmouseup = function (event) {
                if (Math.abs(x2Position - x1Position) < 5) {
                    //点击
                    mouseClick(event); //选中物体颜色高亮，并且聚焦相机
                } else {
                        // console.log( 'move' );
                    }
            };
            ...
            function mouseClick(event) {
                ...
                var mouse3D = new THREE.Vector3((event.clientX - 250) / (window.innerWidth - 250) * 2 - 1, //x
                ...
                (function () {
                    var bndSphere = intersects[0].object.geometry.boundingSphere; //射中物体的包围球，即这个物体内切于球
                    var r = intersects[0].object.geometry.boundingSphere.radius; //球的半径

                    var offset = r / Math.tan(Math.PI / 180.0 * that.orbitControls.object.fov * 0.5);
                    var vector = new THREE.Vector3(0, 0, 1);
                    // console.log( 'vector1' , vector )
                    var dir = vector.applyQuaternion(that.orbitControls.object.quaternion);
                    // console.log( 'vector2' , vector )
                    var newPos = new THREE.Vector3();
                    dir.multiplyScalar(offset * 1.1);
                    newPos.addVectors(bndSphere.center, dir);

                    var oldP = that.orbitControls.object.position;
                    var oldT = that.orbitControls.target;
                    var tween = new _tween2.default.Tween(oldP).to({
                        x: newPos.x,
                        y: newPos.y,
                        z: newPos.z
                    }, 1000)
                     ...
                     * Cubic   立方体动画
                     * Quadratic 2次方动画*/
                    .easing(_tween2.default.Easing.Exponential.InOut).onUpdate(function () {
                        that.orbitControls.target = new THREE.Vector3(bndSphere.center.x, bndSphere.center.y, bndSphere.center.z);
                    });

                    var tween1 = new _tween2.default.Tween(oldT).to({
                        x: newPos.x,
                        y: newPos.y,
                        z: newPos.z
                    }, 10).easing(_tween2.default.Easing.Exponential.InOut).onUpdate(function () {
                        that.orbitControls.object.position.set(newPos.x, newPos.y, newPos.z);
                    });
                    tween.chain(tween1);
                    tween.start();
                })();
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js??ref--0-1!../../../node_modules/postcss-loader/lib/index.js!../../../node_modules/less-loader/dist/cjs.js!./base.less", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js??ref--0-1!../../../node_modules/postcss-loader/lib/index.js!../../../node_modules/less-loader/dist/cjs.js!./base.less");
...
// module
exports.push([module.i, "html,\nbody {\n  padding: 0;\n  margin: 0;\n  width: 100%;\n  height: 100%;\n}\n#detail {\n  position: absolute;\n  top: 0px;\n  left: 0px;\n  width: 250px;\n  height: 100%;\n  border: 1px solid rgba(19, 90, 133, 0.15);\n}\n#webglBox {\n  width: 100%;\n  height: 100%;\n  margin-left: 250px;\n}\n", "", {"version":3,"sources":["C:/kingov/prcts/webgl/060/src/public/css/base.less"],"names":[],"mappings":"AAAA;;EAEE,WAAW;EACX,UAAU;EACV,YAAY;EACZ,aAAa;CACd;AACD;EACE,mBAAmB;EACnB,SAAS;EACT,UAAU;EACV,aAAa;EACb,aAAa;EACb,0CAA0C;CAC3C;AACD;EACE,YAAY;EACZ,aAAa;EACb,mBAAmB;CACpB","file":"base.less","sourcesContent":["html,\nbody {\n  padding: 0;\n  margin: 0;\n  width: 100%;\n  height: 100%;\n}\n#detail {\n  position: absolute;\n  top: 0px;\n  left: 0px;\n  width: 250px;\n  height: 100%;\n  border: 1px solid rgba(19, 90, 133, 0.15);\n}\n#webglBox {\n  width: 100%;\n  height: 100%;\n  margin-left: 250px;\n}\n"],"sourceRoot":""}]);
